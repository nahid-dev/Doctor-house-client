  ...
  return (
    <div className="min-h-screen">
      <div className="grid grid-cols-1 md:grid-cols-2 ">
        <div className="primary-bg max-h-screen">
        ...
        <div className="flex items-center md:h-screen justify-center my-10">
          <div className="border rounded-lg m-5 p-5 md:p-10 text-center md:w-3/4">
            <div>
