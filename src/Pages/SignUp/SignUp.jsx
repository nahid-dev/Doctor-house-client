  ...
  return (
    <div className="">
      <div className="grid grid-cols-1 md:grid-cols-2 ">
        <div className="primary-bg relative block">
        ...
        <div className="flex items-center justify-center md:my-16 mt-10 md:mt-0">
          <div className="border rounded-lg md:p-10 text-center md:w-3/4 m-3 md:m-0 p-3">
            <div>
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                {/* USERNAME */}
                <div className="flex flex-col text-left mb-3">
                  <label className="text-xl font-semibold mb-3">Username</label>
                  <input
                    type="text"
                    className="text-[#9D9C9C] p-5 bg-[#F3F3F3] placeholder-[#9D9C9C] rounded-lg focus-visible:outline-none"
